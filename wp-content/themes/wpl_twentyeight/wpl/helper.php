...
class wpl_helper extends wpl_theme
{
	...
	public function init()
	{
		...
		add_action('wp_footer', array($this, 'page_preload'), 20);
	...
	public function wpl_theme_header()
	{
        ...
        if(!is_admin())
        {
            ...
            $font_array = array($this->theme_options['main_font'], $this->theme_options['header_font'], $this->theme_options['footer_font'],$this->theme_options['plisting_font'],$this->theme_options['pshow_price_font'], 'Montserrat:400,700');
            $google_fonts = '';
