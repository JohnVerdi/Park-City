        ...
        <div class="right-panel tab-content col-md-10">
            ...
            <div class="panel-wp tab-pane fade in active" id="general-options">
                <table class="wpl_theme_options_table">
                    ...
                    <tr>
                        <td>
                            <label for="wpl_theme_options_page_preloader"><?php _e('Enable Preloader', 'wplt'); ?></label>
                            <span class="info_text">
                                <?php _e('Enable website preloader.', 'wplt'); ?>
                            </span>
                        </td>
                        <td>
                            <input type="checkbox" id="wpl_theme_options_page_preloader"
                                   name="wpl_theme_options[page_preloader]" <?php echo(($this->isset_variable('page_preloader', $theme_options) and $theme_options['page_preloader'] == 1) ? 'checked="checked"' : '') ?> />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="panel-wp tab-pane fade" id="header-options">
                <table class="wpl_theme_options_table">
                    ...
                    <tr>
                        <td>
                            <label for="wpl_theme_options_h_position"><?php _e('Content below header at homepage', 'wplt'); ?></label>
                            <span class="info_text"><?php _e('This will effect when Transparent header is enabled', 'wplt'); ?></span>
                        </td>
                        <td>
                            <input type="checkbox" id="wpl_theme_options_h_position" name="wpl_theme_options[h_position]"
                                <?php echo(($this->isset_variable('h_position', $theme_options) and $theme_options['h_position'] == 1) ? 'checked="checked"' : '') ?> >
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="panel-wp tab-pane fade" id="footer-options">
                <table class="wpl_theme_options_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="wpl_theme_options_footer_columns" name="wpl_theme_options[footer_columns] <?php  if(!isset($this->theme_options['footer_columns'])) echo "3"; ?>">
                                <option value="1" <?php echo((isset($this->theme_options['footer_columns']) and $this->theme_options['footer_columns'] == '1') ? 'selected="selected"' : '') ?>>1</option>
                                <option value="2" <?php echo((isset($this->theme_options['footer_columns']) and $this->theme_options['footer_columns'] == '2') ? 'selected="selected"' : '') ?>>2</option>
                                <option value="3" <?php echo(((isset($this->theme_options['footer_columns']) and $this->theme_options['footer_columns'] == '3') || (!isset($this->theme_options['footer_columns']))) ? 'selected="selected"' : '') ?>>3</option>
                                <option value="4" <?php echo((isset($this->theme_options['footer_columns']) and $this->theme_options['footer_columns'] == '4') ? 'selected="selected"' : '') ?>>4</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="panel-wp tab-pane fade" id="social-icons-options">
                <table class="wpl_theme_options_table">
                    ...
                    <tr>
                        <td>
                            <label for="wpl_theme_options_email"><?php _e('Google+', 'wplt'); ?></label>
                            <span
                                class="info_text"><?php _e('Leave it blank if you want to remove the icon', 'wplt'); ?></span>
                        </td>
                        <td>
