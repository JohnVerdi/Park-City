...
echo((isset($theme_options['h_position']) and $theme_options['h_position'] == 1) ? ' wpl-28-header-content-below-header' : '');
...
<head>
    ...
    <link id="wpl-28-favicon" rel="shortcut icon"
          href="<?php echo ($theme_options['favicon']) ? $theme_options['favicon'] : get_template_directory_uri() . '/assets/images/favicon.ico' ?>"/>
...
<?php
if (isset($theme_options['page_preloader']) and $theme_options['page_preloader'] == 1) {
        ...
        <div class="wpl-28-header-holder">
            ...
            switch ($theme_options['header']) {
                ...
                case '2':
                    ?>
                    <div
                        class="container header_cont clearfix <?php echo($theme_options['header'] ? 'header_type_' . $theme_options['header'] : ''); ?>">
                        <div class="row">
                                ...
                                <div class="col-md-8 header_top_right">
                                    ...
                                    <div id="login_box">
                                        <?php if (!$wpl_helper->is_user_logged_in()): ?>
                                            ...
                                            <?php if (get_option('users_can_register')): ?>
                                                <a href="<?php echo $wpl_helper->wp_registration_url(); ?>"
                                                   id="register_link"><i
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php if (class_exists('wpl_global') and wpl_global::check_addon('membership') and wpl_global::get_setting('membership_user_action_urls') == '1'):
                                                $membership = new wpl_addon_membership(); ?>
                                                <a href="<?php echo $membership->URL('dashboard'); ?>"
                                                   id="membership_link">
                ...
                case '3':
                    ?>
                    <div
                        class="header_cont clearfix <?php echo($theme_options['header'] ? 'header_type_' . $theme_options['header'] : ''); ?>">
                        <div class="row">
                                        ...
                                        <div id="login_box">
                                            <?php if (!$wpl_helper->is_user_logged_in()): ?>
                                                ...
                                                <?php if (get_option('users_can_register')): ?><a
                                                    href="<?php echo $wpl_helper->wp_registration_url(); ?>"
                                                    id="register_link"><i
                                                        class="icon-user"></i><?php _e('Register', 'wplt') ?>
                                                    </a>
                                                <?php endif; ?>
                            ...
                            <div class="header_top_bar clearfix">
                                <div id="login_box" class="col-md-6">
                                    <?php if (!$wpl_helper->is_user_logged_in()): ?>
                                        ...
                                        <?php if (get_option('users_can_register')): ?><a
                                            href="<?php echo $wpl_helper->wp_registration_url(); ?>" id="register_link">
                                            <i
                                                class="icon-user"></i><?php _e('Register', 'wplt') ?>
                                            </a><?php endif; ?>
                                    <?php else: ?>
                ...
                case '9':
                    ...
                    <div
                        ...
                        <div class="row">
                            ...
                            <div class="header_bot clearfix">
                                <div
                                    class="header_bot_left col-md-9 wpl-28-main-menu-has-overflow visible-md-block visible-lg-block">
                                    <?php $wpl_helper->get_menu(array('theme_location' => 'top-menu', 'menu_class' => 'nav-menu')); ?>
                                </div>
