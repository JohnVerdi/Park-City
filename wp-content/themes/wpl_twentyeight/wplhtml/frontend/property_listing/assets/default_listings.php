...
else
{
    ...
    foreach($this->wpl_properties as $key => $property)
    {
        ...
        $bathroom = (isset($property['materials']['bathrooms']['value']) and ($_bathrooms = floatval($property['materials']['bathrooms']['value']))) ? sprintf('<div class="bathroom">%s<span>%s</span></div>', $_bathrooms, __("Bathroom", "wpl")) : '';
