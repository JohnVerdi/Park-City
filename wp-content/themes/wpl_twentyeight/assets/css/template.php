...
$content_below_header  = isset($_GET['h_position']) ? $_GET['h_position'] : '1';

$font_array = array($main_font , $header_font , $footer_font, $plisting_font, $pshow_price_font);
$google_fonts='';
...
?>
    ...
    .wpl-28-template-wp .wpl-28-header-wp .header_cont{background:<?php echo $body; ?>;}
...
<?php if($body_pattern){?>
    ...
    .wpl-28-template-wp #main_box_container,
    .wpl-28-template-wp #top_footer_rows,
    .wpl-28-template-wp .wpl-28-header-wp .header_cont{background-image:url(../images/pattern/<?php echo $body_pattern_value ?>/<?php echo $body_pattern_value ?>.png);background-repeat:repeat;}
<?php } ?>
