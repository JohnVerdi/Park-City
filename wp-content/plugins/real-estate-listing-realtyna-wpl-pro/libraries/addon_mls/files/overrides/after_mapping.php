...
$address = $address . ' ' . $wpl_listing['zip_name']['wpl_value'];

//if(isset($wpl_listing['googlemap_lt']) and empty($wpl_listing['googlemap_lt']['mls_value']))
//{
...
{
	$mls_listing_type_value = $wpl_listing['mls_class_id']['wpl_value'] == 'RRTL' ? 10 : 9;
    $arr = array();
    $arr['wpl_value'] = $mls_listing_type_value;
...
//echo '<pre>'.print_r($wpl_listing, true).'</pre>'; exit();